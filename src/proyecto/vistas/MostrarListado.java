...
public class MostrarListado extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lstPanelListado = new javax.swing.JList<>();
        ...
        lstPanelListado.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        lstPanelListado.setEnabled(false);
        jScrollPane2.setViewportView(lstPanelListado);
    ...
    public javax.swing.JList<String> lstPanelListado;
